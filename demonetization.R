...
ggplot(demonet_sentiment_afinn, aes(score,n, fill = score)) + geom_bar(stat="identity") + labs(title = "Demonetisation sentiment analysis", x = " Polarity of Sentiment", y = "Tweet Count")
#Forming wordcloud
